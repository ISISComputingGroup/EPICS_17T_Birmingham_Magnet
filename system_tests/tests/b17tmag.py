...
class B17TmagTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ca = ChannelAccess(
            default_timeout=5, default_wait_time=0.0, device_prefix=DEVICE_PREFIX
        )
    ...
    def test_WHEN_backdoor_property_set_THEN_readback_updates(
        self, _, backdoor_name, pv_name, values
    ):
        for value in values:
    ...
    @parameterized.expand([("MACROSTATREADENABLED", 0), ("MACROSTATREADDISABLED", 1)])
